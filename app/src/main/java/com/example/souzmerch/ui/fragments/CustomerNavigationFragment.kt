...
class CustomerNavigationFragment :
    BaseFragment<FragmentCustomerNavigationBinding>(FragmentCustomerNavigationBinding::inflate) {
    ...
    private fun navigateToCreateMission(shop: Shop) {
        val action = CustomerNavigationFragmentDirections.actionCustomerNavigationFragmentToShopsBySupervisorFragment(shop.id)
